...
// function to get Account details using FOR loop
    ...
    if(typeof username !== 'undefined'){
        ...
        for(var i=0; i < accounts.length; i++){
            if(accounts[i].username === username){
                searchedAccount.account = account[i];
                searchedAccount.index = i;
...
function deposit(account, amount){
    if(typeof account !== 'undefined' && account.username && typeof amount === 'number'){
        ...
        console.log('Please enter account information correctly. Depositing in account should contain username as string and amount as number')
    }
}
...
function withdraw(account, amount){
    if(typeof account !== 'undefined' && account.username && typeof amount === 'number'){
        ...
        console.log('Please enter account information correctly. Withdraing in account should contain username  as string and amount in string')
    }
}
